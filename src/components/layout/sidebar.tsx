...
const navItems = [
  ...
  { title: "Sales", icon: DollarSign, isActive: false },
  { title: "Advertising", icon: Megaphone, isActive: false },
  { title: "Subscriptions", icon: RefreshCw, isActive: false },
  { title: "Products", icon: Package, isActive: false },
];
